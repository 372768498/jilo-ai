        ...
        <>
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc pl-5 text-sm space-y-1">
              <li><Link className="underline" href="/en/news">/en/news</Link> — list shows at least one item</li>
              <li><Link className="underline" href="/en/tools">/en/tools</Link> — filters work, cards show Compare/Save</li>
              <li><Link className="underline" href="/compare">/compare</Link> — table renders after selecting tools</li>
              <li><Link className="underline" href="/submit">/submit</Link> — submit a tool → submissions table updated</li>
              <li><Link className="underline" href="/weekly">/weekly</Link> — top headlines & updates (if any)</li>
              <li><Link className="underline" href="/admin/updates">/admin/updates</Link> — add an update with ADMIN_KEY</li>
            </ul>
          </section>
        </>
      )}
