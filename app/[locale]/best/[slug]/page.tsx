...
const bestMeta: Record<string, {
  ...
  "best-ai-chatbots": {
    category: "Chatbots", icon: "💬", count: 15, lastUpdated: "2026-02-01",
    title_en: "15 Best AI Chatbots in 2026: Comprehensive Guide",
    title_zh: "2026年15个最佳AI聊天机器人",
    description_en: "Compare the best AI chatbots including ChatGPT, Claude, Gemini and more.",
    description_zh: "最佳AI聊天机器人对比。",
  },
  "best-ai-image-generators": {
    category: "Image Generation", icon: "🖼️", count: 15, lastUpdated: "2026-02-01",
    title_en: "15 Best AI Image Generators in 2026",
    title_zh: "2026年15个最佳AI图像生成器",
    description_en: "Top AI image generators for art, design, and creative work.",
    description_zh: "最佳AI图像生成工具。",
  },
  "best-ai-marketing-tools": {
    category: "Marketing", icon: "📢", count: 15, lastUpdated: "2026-02-01",
    title_en: "15 Best AI Marketing Tools in 2026",
    title_zh: "2026年15个最佳AI营销工具",
    description_en: "Top AI tools for marketing automation, copywriting, and analytics.",
    description_zh: "最佳AI营销工具。",
  },
  "best-ai-productivity-tools": {
    category: "Productivity", icon: "⚡", count: 15, lastUpdated: "2026-02-01",
    title_en: "15 Best AI Productivity Tools in 2026",
    title_zh: "2026年15个最佳AI效率工具",
    description_en: "Boost your workflow with the best AI productivity tools.",
    description_zh: "最佳AI效率工具。",
  },
  "best-ai-search-engines": {
    category: "Search", icon: "🔍", count: 10, lastUpdated: "2026-02-01",
    title_en: "10 Best AI Search Engines in 2026",
    title_zh: "2026年10个最佳AI搜索引擎",
    description_en: "Compare the best AI-powered search engines for research and discovery.",
    description_zh: "最佳AI搜索引擎。",
  },
  "best-ai-presentation-tools": {
    category: "Presentations", icon: "📊", count: 10, lastUpdated: "2026-02-01",
    title_en: "10 Best AI Presentation Tools in 2026",
    title_zh: "2026年10个最佳AI演示工具",
    description_en: "Create stunning presentations with the best AI presentation tools.",
    description_zh: "最佳AI演示工具。",
  },
  "best-ai-music-generators": {
    category: "Music", icon: "🎵", count: 10, lastUpdated: "2026-02-01",
    title_en: "10 Best AI Music Generators in 2026",
    title_zh: "2026年10个最佳AI音乐生成器",
    description_en: "Create original music with the best AI music generation tools.",
    description_zh: "最佳AI音乐生成工具。",
  },
  "best-ai-meeting-assistants": {
    category: "Meetings", icon: "🤝", count: 10, lastUpdated: "2026-02-01",
    title_en: "10 Best AI Meeting Assistants in 2026",
    title_zh: "2026年10个最佳AI会议助手",
    description_en: "Never miss a detail with the best AI meeting assistants and note-takers.",
    description_zh: "最佳AI会议助手。",
  },
  "best-ai-tools-for-startups": {
    category: "Startups", icon: "🚀", count: 15, lastUpdated: "2026-02-01",
    title_en: "15 Best AI Tools for Startups in 2026",
    title_zh: "2026年15个最佳创业AI工具",
    description_en: "Essential AI tools every startup needs to move fast and save money.",
    description_zh: "创业必备AI工具。",
  },
  "best-ai-tools-for-developers": {
    category: "Developers", icon: "👨‍💻", count: 15, lastUpdated: "2026-02-01",
    title_en: "15 Best AI Tools for Developers in 2026",
    title_zh: "2026年15个最佳开发者AI工具",
    description_en: "Essential AI tools for software developers, from coding to deployment.",
    description_zh: "开发者必备AI工具。",
  },
};
